...
-- -----------------------------------------------------
-- Table `DrVera`.`DeliveryGroups`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`DeliveryGroups` (
...
CREATE TABLE IF NOT EXISTS `DrVera`.`DeliveryGroupHasUsers` (
  ...
  CONSTRAINT `fk_Users_has_DeliveryGroups_DeliveryGroups1`
    ...
    REFERENCES `DrVera`.`DeliveryGroups` (`DeliveryGroupId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `DrVera`.`SmsTemplates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`SmsTemplates` (
...
-- -----------------------------------------------------
-- Table `DrVera`.`EmailTemplates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`EmailTemplates` (
  ...
  INDEX `fk_DeliveryGroups_Users1_idx` (`UserCreated` ASC),
  CONSTRAINT `fk_DeliveryGroups_Users100`
    FOREIGN KEY (`UserCreated`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `DrVera`.`Cron`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`Cron` (
  `CronId` INT NOT NULL AUTO_INCREMENT,
  `Pattern` VARCHAR(45) NOT NULL,
  `UserCreated` INT(11) NOT NULL,
  `DateCreated` DATETIME NOT NULL,
  `Deleted` TINYINT(1) NOT NULL DEFAULT '0',
  `SmsTemplate` INT NULL,
  `EmailTemplate` INT NULL,
  PRIMARY KEY (`CronId`),
  INDEX `fk_DeliveryGroups_Users1_idx` (`UserCreated` ASC),
  INDEX `fk_Cron_SmsTemplates1_idx` (`SmsTemplate` ASC),
  INDEX `fk_Cron_EmailTemplates1_idx` (`EmailTemplate` ASC),
  CONSTRAINT `fk_DeliveryGroups_Users101`
    FOREIGN KEY (`UserCreated`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cron_SmsTemplates1`
    FOREIGN KEY (`SmsTemplate`)
    REFERENCES `DrVera`.`SmsTemplates` (`SmsTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cron_EmailTemplates1`
    FOREIGN KEY (`EmailTemplate`)
    REFERENCES `DrVera`.`EmailTemplates` (`EmailTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DrVera`.`CronHasRecipients`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`CronHasRecipients` (
  `CronHasRecipientsId` INT(11) NOT NULL,
  `Cron` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_SmsTemplates_copy1_Cron1_idx` (`Cron` ASC),
  INDEX `fk_SmsTemplates_copy1_Users1_idx` (`User` ASC),
  PRIMARY KEY (`CronHasRecipientsId`),
  ...
  CONSTRAINT `fk_SmsTemplates_copy1_DeliveryGroups1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SmsTemplates_copy1_Cron1`
    FOREIGN KEY (`Cron`)
    REFERENCES `DrVera`.`Cron` (`CronId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `DrVera`.`TransactionLogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`TransactionLogs` (
  ...
  INDEX `fk_DeliveryGroups_Users1_idx` (`UserCreated` ASC),
  INDEX `fk_TransactionLogs_DeliveryGroups1_idx` (`DeliveryGroup` ASC),
  CONSTRAINT `fk_DeliveryGroups_Users103`
    FOREIGN KEY (`UserCreated`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TransactionLogs_DeliveryGroups1`
    FOREIGN KEY (`DeliveryGroup`)
    REFERENCES `DrVera`.`DeliveryGroups` (`DeliveryGroupId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DrVera`.`EmailLogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`EmailLogs` (
  `EmailLogId` INT(11) NOT NULL,
  `UId` VARCHAR(255) NOT NULL,
  `Status` TINYINT NOT NULL,
  `SmsTemplate` INT(11) NULL,
  `EmailTemplate` INT(11) NULL,
  `Recipient` INT(11) NULL,
  `Transaction` INT(11) NULL,
  `UserCreated` INT(11) NOT NULL,
  `DateCreated` DATETIME NOT NULL,
  `Deleted` TINYINT(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`EmailLogId`),
  INDEX `fk_DeliveryGroups_Users1_idx` (`UserCreated` ASC),
  INDEX `fk_EmailLogs_SmsTemplates1_idx` (`SmsTemplate` ASC),
  INDEX `fk_EmailLogs_EmailTemplates1_idx` (`EmailTemplate` ASC),
  INDEX `fk_EmailLogs_TransactionLogs1_idx` (`Transaction` ASC),
  INDEX `fk_EmailLogs_Users1_idx` (`Recipient` ASC),
  CONSTRAINT `fk_DeliveryGroups_Users1030`
    FOREIGN KEY (`UserCreated`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_SmsTemplates1`
    FOREIGN KEY (`SmsTemplate`)
    REFERENCES `DrVera`.`SmsTemplates` (`SmsTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_EmailTemplates1`
    FOREIGN KEY (`EmailTemplate`)
    REFERENCES `DrVera`.`EmailTemplates` (`EmailTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_TransactionLogs1`
    FOREIGN KEY (`Transaction`)
    REFERENCES `DrVera`.`TransactionLogs` (`TransactionLogId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_Users1`
    FOREIGN KEY (`Recipient`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DrVera`.`SmsLogs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`SmsLogs` (
  ...
  CONSTRAINT `fk_DeliveryGroups_Users10300`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_SmsTemplates10`
    FOREIGN KEY (`SmsTemplate`)
    REFERENCES `DrVera`.`SmsTemplates` (`SmsTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmailLogs_EmailTemplates10`
    FOREIGN KEY (`EmailTemplate`)
    REFERENCES `DrVera`.`EmailTemplates` (`EmailTemplateId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
