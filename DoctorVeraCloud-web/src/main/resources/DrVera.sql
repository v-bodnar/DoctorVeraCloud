...
CREATE TABLE IF NOT EXISTS `DrVera`.`Share` (
  ...
  `PercentageDoctor` FLOAT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `DrVera`.`ShareHasMethods`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`ShareHasMethods` (
  `Share` INT(11) NOT NULL,
  `Method` INT(11) NOT NULL,
  PRIMARY KEY (`Share`, `Method`),
  INDEX `fk_Share_has_Methods_Methods1_idx` (`Method` ASC),
  INDEX `fk_Share_has_Methods_Share1_idx` (`Share` ASC),
  CONSTRAINT `fk_Share_has_Methods_Share1`
    FOREIGN KEY (`Share`)
    REFERENCES `DrVera`.`Share` (`ShareId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Share_has_Methods_Methods1`
    FOREIGN KEY (`Method`)
    REFERENCES `DrVera`.`Methods` (`MethodId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DrVera`.`ShareHasDoctors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`ShareHasDoctors` (
  `Share` INT(11) NOT NULL,
  `Doctor` INT(11) NOT NULL,
  PRIMARY KEY (`Share`, `Doctor`),
  INDEX `fk_Share_has_Users_Users1_idx` (`Doctor` ASC),
  INDEX `fk_Share_has_Users_Share1_idx` (`Share` ASC),
  CONSTRAINT `fk_Share_has_Users_Share1`
    FOREIGN KEY (`Share`)
    REFERENCES `DrVera`.`Share` (`ShareId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Share_has_Users_Users1`
    FOREIGN KEY (`Doctor`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `DrVera`.`ShareHasAssistants`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DrVera`.`ShareHasAssistants` (
  `Share` INT(11) NOT NULL,
  `Assistant` INT(11) NOT NULL,
  PRIMARY KEY (`Share`, `Assistant`),
  INDEX `fk_Share_has_Users1_Users1_idx` (`Assistant` ASC),
  INDEX `fk_Share_has_Users1_Share1_idx` (`Share` ASC),
  CONSTRAINT `fk_Share_has_Users1_Share1`
    FOREIGN KEY (`Share`)
    REFERENCES `DrVera`.`Share` (`ShareId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Share_has_Users1_Users1`
    FOREIGN KEY (`Assistant`)
    REFERENCES `DrVera`.`Users` (`UserId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
